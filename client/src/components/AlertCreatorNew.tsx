...
interface AlertCreatorProps {
  ...
  onBack: () => void
  type: AlertType
  onCreate: (type: AlertType, name: string, symbol: string | undefined, params: Record<string, any>) => void
}
...
export default function AlertCreatorNew({ onClose, onBack, type, onCreate }: AlertCreatorProps) {
